...
# Function to save the fitness of the final population to txt file
...
# plotting the pareto front after few 1000 evaluations
...
# function to find eucledian distance between 2 given points
